...
class Match:
    def __init__(self, player1, player2, player1_score=0, player2_score=0, match_result=None,
                 match_id=None):
    ...
    def set_result(self):
        result = TournamentManagerView.set_match_result(self.player1, self.player2)
        match result:
            case "1":
    ...
    def to_dict(self):
        return {
            ...
            "match_result": ([self.player1.chess_id, self.player1_score], [self.player2.chess_id, self.player2_score]),
    ...
    def from_dict(cls, data):
        ...
        return cls(
            ...
            match_result=([player1, int(data["player1_score"])], [player2, int(data["player2_score"])]),
