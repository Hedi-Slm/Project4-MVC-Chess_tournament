...
class TournamentManagerController:
    ...
    def choose_tournament(self):
        choice = TournamentManagerView.choose_tournament(list(self.tournaments.values()))
        return choice
    ...
    def modify_tournament_details(self):
        ...
        while True:
            TournamentManagerView.change_tournament_details_menu(self.chosen_tournament)
            choice = TournamentManagerView.get_user_choice()

            match choice:
                case "1":
                    new_tournament_name = TournamentManagerView.get_new_tournament_name(self.chosen_tournament.name)
                    self.chosen_tournament.name = new_tournament_name
                case "2":
                    new_tournament_location = (TournamentManagerView.get_new_tournament_location
                                               (self.chosen_tournament.location))
                    self.chosen_tournament.location = new_tournament_location
                case "3":
                    new_tournament_start_date = (TournamentManagerView.get_new_tournament_start_date
                                                 (self.chosen_tournament.start_date, self.chosen_tournament.end_date))
                    self.chosen_tournament.start_date = new_tournament_start_date
                case "4":
                    new_tournament_end_date = (TournamentManagerView.get_new_tournament_end_date
                                               (self.chosen_tournament.end_date, self.chosen_tournament.start_date))
                    self.chosen_tournament.end_date = new_tournament_end_date
                case "5":
                    new_tournament_number_rounds = (TournamentManagerView.get_new_number_of_rounds
                                                    (self.chosen_tournament.number_rounds))
                    self.chosen_tournament.number_rounds = new_tournament_number_rounds
                case "6":
                    new_tournament_description = (TournamentManagerView.get_new_tournament_description
                                                  (self.chosen_tournament.description))
                    self.chosen_tournament.description = new_tournament_description
                case "7":
                    break
                case _:
    ...
    def show_tournament_manager_menu(self):
        while True:
            ...
            match choice:
                ...
                case "3":
                    TournamentManagerView.display_tournament_details(self.chosen_tournament)
                case "4":
                    TournamentManagerView.display_players(self.chosen_tournament.players)
                case "5":
